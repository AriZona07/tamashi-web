    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-background p-6 text-center text-foreground">
      <main className="flex w-full max-w-3xl flex-col items-center gap-8">
        ...
        <h1 className="text-4xl font-bold tracking-tight sm:text-6xl">
          <b>Tamashi: <br></br>
          Aprendamos a Crecer</b>
        </h1>

        {/* Descripción */}
        <p className="max-w-xl text-lg leading-8 text-muted-foreground">
          Descubre una nueva manera de formar hábitos. Descarga nuestra aplicación y cumple tus metas.
        </p>
        {/* Mensaje de Bienvenida */}
        <p className="max-w-xl text-lg leading-8 text-muted-foreground">
          ¡Ahora disponible para todo el público desde la Google Play Store!
        </p>
